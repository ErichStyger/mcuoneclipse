...
/* identification of CPU/core used. __CORTEX_M is defined in CMSIS-Core.
   Otherwise CPU Family is set automatically by Processor Expert: detected: S32K (supported: "Kinetis", "S32K", "HCS08")
*/
...
#define MCUC1_CONFIG_CPU_IS_S32K            (1 && MCUC1_CONFIG_CPU_IS_ARM_CORTEX_M)
...
#else
  #define MCUC1_CONFIG_SDK_VERSION_USED  MCUC1_CONFIG_SDK_S32K
