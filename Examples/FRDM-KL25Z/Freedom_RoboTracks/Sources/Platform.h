...
#define PL_HAS_LINE_SENSOR            (0 && (PL_IS_TRACK_ROBOT || PL_IS_ZUMO_ROBOT || PL_IS_ROUND_ROBOT)) /* if we have line sensors */
...
#define PL_APP_LINE_FOLLOWING         ((0 && PL_HAS_LINE_SENSOR) || PL_APP_LINE_MAZE)/* simple line following */
