...
#ifdef PL_INVERT_LEFT_MOTOR_DIRECTION
  CLS1_SendStatusStr((unsigned char*)"  invert L", (unsigned char*)"inverted\r\n", io->stdOut);
#else
  CLS1_SendStatusStr((unsigned char*)"  invert L", (unsigned char*)"normal\r\n", io->stdOut);
#endif
#ifdef PL_INVERT_RIGHT_MOTOR_DIRECTION
  CLS1_SendStatusStr((unsigned char*)"  invert R", (unsigned char*)"inverted\r\n", io->stdOut);
#else
  CLS1_SendStatusStr((unsigned char*)"  invert R", (unsigned char*)"normal\r\n", io->stdOut);
#endif
