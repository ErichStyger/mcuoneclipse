...
/* only set one! */
#define PL_IS_ZUMO_ROBOT  1 /* set to 1 if we are the Pololu Zumo Chassis */
#define PL_IS_ROUND_ROBOT 0 /* set to 1 if we are the round Pololu Chassis */
...
#define PL_TURN_ON_FINISH             1                  /* if we turn around on the finish area */
#define PL_GO_DEADEND_BW              1                  /* if we go backwards after a dead end */
