readme.txt
----------
This project implements a logic analyzer using the FRDM-KL25Z board.
DMA support added by Reiner Geiger, refactoring by Erich Styger.

PWM1 (and TU1) produce a test signal (1 ms duty cycle) which can be used for tests.
