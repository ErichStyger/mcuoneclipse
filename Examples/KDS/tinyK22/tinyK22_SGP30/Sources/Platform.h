...
#define PL_CONFIG_HAS_SW_I2C      (1 && PL_CONFIG_HAS_I2C)
#define PL_CONFIG_HAS_I2C_SPY     (0 && PL_CONFIG_HAS_I2C)
#define PL_CONFIG_HAS_SEGGER_RTT  (1)
#define PL_CONFIG_HAS_USB_CDC     (0)
#define PL_CONFIG_HAS_TSL2561     (1 && PL_CONFIG_HAS_I2C) /* ambient light sensor */
#define PL_CONFIG_HAS_SGP30       (0 && PL_CONFIG_HAS_I2C) /* air quality sensor */
#define PL_CONFIG_HAS_RTC_DS3231  (1 && PL_CONFIG_HAS_I2C)
...
#define PL_CONFIG_HAS_MMA8451     (1 && PL_CONFIG_HAS_I2C) /* accelerometer */
#define PL_CONFIG_HAS_SHT31       (0 && PL_CONFIG_HAS_I2C) /* temperature/humidity */
#define PL_CONFIG_HAS_SD_CARD     (0 && PL_CONFIG_HAS_SPI)
#define PL_CONFIG_HAS_NEO_PIXEL   (1) /* WS2812B */
#define PL_CONFIG_HAS_AMG8833     (0 && PL_CONFIG_HAS_I2C) /* thermal sensor */
