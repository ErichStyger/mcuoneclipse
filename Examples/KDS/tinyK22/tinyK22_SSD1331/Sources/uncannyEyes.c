...
extern const lv_img_t default_upper;
extern const lv_img_t default_lower;
extern const lv_img_t default_iris;
...
static const EyeDesc eyes[] = {
  {
    ...
    .iris  = &default_iris,
    .screen.width = DEFAULT_SCREEN_WIDTH, .screen.height = DEFAULT_SCREEN_HEIGHT,
    .screen.upper = &default_upper, .screen.lower = &default_upper,
