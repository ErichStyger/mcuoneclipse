...
try:    prefix = sys.argv[1]
except: prefix = "DEFAULT"
...
print "#define " + prefix + "SCLERA_WIDTH "   + str(im.size[0])
print "#define " + prefix + "SCLERA_HEIGHT "  + str(im.size[1])
print

sys.stdout.write("const uint16_t "+prefix+"sclera["+prefix+"SCLERA_HEIGHT]["+prefix+"SCLERA_WIDTH] = {")
...
print
print "#define " + prefix + "IRIS_MAP_WIDTH "   + str(im.size[0])
print "#define " + prefix + "IRIS_MAP_HEIGHT "  + str(im.size[1])
print
...
print
print "#define " + prefix + "SCREEN_WIDTH "   + str(im.size[0])
print "#define " + prefix + "SCREEN_HEIGHT "  + str(im.size[1])
print
...
print
print "#define " + prefix + "IRIS_WIDTH "   + str(im.size[0])
print "#define " + prefix + "IRIS_WIDTH "  + str(im.size[1])
...
sys.stdout.write("\nconst uint16_t " + prefix + "polar[%s][%s] = {" % (irisSize, irisSize))
