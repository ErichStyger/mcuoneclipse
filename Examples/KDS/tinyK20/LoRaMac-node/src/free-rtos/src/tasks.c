        ...
        const MemoryRegion_t * const xRegions ) /*lint !e971 Unqualified char types are allowed for strings and single characters only. */
{
    ...
    configASSERT(
            ((uxPriority & (UBaseType_t)(~portPRIVILEGE_BIT))
...
void vTaskStartScheduler( void )
{
...
#else
    {
        ...
        xReturn = xTaskCreate(prvIdleTask, "IDLE", tskIDLE_STACK_SIZE, (void *) NULL,
                (tskIDLE_PRIORITY | portPRIVILEGE_BIT), NULL); /*lint !e961 MISRA exception, justified as it is not a redundant explicit cast to all supported compilers. */
    }
        ...
        StackType_t * const puxStackBuffer )
{
...
#else /* portSTACK_GROWTH */
    {
        ...
        pxStack = (StackType_t *) pvPortMallocAligned(
                (((size_t) usStackDepth) * sizeof(StackType_t)), puxStackBuffer); /*lint !e961 MISRA exception as the casts are only redundant for some ports. */
