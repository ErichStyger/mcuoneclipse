...
#define PTRC1_vTraceSetTimerFrequency(frequency) \
...
#define PTRC1_xTraceOpenLabel(label) \
...
#define PTRC1_vTraceUserEvent(eventLabel) \
...
#define PTRC1_vTraceSetISRProperties(handle, name, prioritiy) \
...
#define PTRC1_vTraceStoreISRBegin(id) \
...
#define PTRC1_vTraceStoreISREnd(pendingISR) \
...
#define PTRC1_vTraceTaskSkipDefaultInstanceFinishedEvents() \
...
#define PTRC1_vTraceTaskInstanceIsFinished() \
...
#define PTRC1_vTraceExcludeTaskFromSchedulingTrace(name) \
...
#define PTRC1_vTraceInitTraceData() \
  vTraceInitTraceData()
...
#define PTRC1_vTraceTaskInstanceFinish() \
...
#define PTRC1_vTraceTaskInstanceFinishDirect() \
