...
**     Date/Time   : 2016-07-31, 11:14, # CodeGen: 9
**     Abstract    :
...
**              Port Folder                                : FreeRTOS\Source\portable\GCC\ARM_CM7F
...
osa_status_t OSA_Init(void) {
  PTRC1_vTraceInitTraceData();/* initialize trace first, as needed by RTOS functions */
