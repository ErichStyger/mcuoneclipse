...
#else /* << EST */
              Utility_strcat(pcWriteBuffer, bufSize, (const unsigned char*)pxTaskStatusArray[ x ].pcTaskName);
              Utility_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              Utility_chcat(pcWriteBuffer, bufSize, (unsigned char)cStatus);
              Utility_chcat(pcWriteBuffer, bufSize, (unsigned char)'\t');
              Utility_strcatNum32u((unsigned char*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].uxCurrentPriority);
              Utility_chcat(pcWriteBuffer, bufSize, (unsigned char)'\t');
              Utility_strcatNum32u(pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].usStackHighWaterMark);
              Utility_chcat(pcWriteBuffer, bufSize, (unsigned char)'\t');
              Utility_strcatNum32u(pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].xTaskNumber);
              Utility_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"\r\n");
#endif
...
/*----------------------------------------------------------*/
        ...
        unsigned long ulTotalTime, ulStatsAsPercentage;
              ...
              Utility_strcat(pcWriteBuffer, bufSize, (const unsigned char*)pxTaskStatusArray[ x ].pcTaskName);
              Utility_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              Utility_strcatNum32u((unsigned char*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].ulRunTimeCounter);
              Utility_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              Utility_strcatNum32u(pcWriteBuffer, bufSize, ulStatsAsPercentage);
              Utility_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"%\r\n");
#endif
                                                }
                                                #endif
              ...
              Utility_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              Utility_strcatNum32u((unsigned char*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].ulRunTimeCounter);
              Utility_strcat(pcWriteBuffer, bufSize, (const unsigned char*)"\t\t<1%\r\n");
#endif
                                                }
                                                #endif
                                        }
