...
**     Date/Time   : 2013-08-17, 22:17, # CodeGen: 0
**     Abstract    :
...
void RTOS_vApplicationStackOverflowHook(xTaskHandle pxTask, signed portCHAR *pcTaskName);
/*
** ===================================================================
...
void RTOS_vOnPreSleepProcessing(portTickType expectedIdleTicks);
/*
** ===================================================================
**     Event       :  RTOS_vOnPreSleepProcessing (module Events)
**
**     Component   :  RTOS [FreeRTOS]
**     Description :
...
/*
** ===================================================================
**     Event       :  RTOS_vOnPostSleepProcessing (module Events)
**
**     Component   :  RTOS [FreeRTOS]
**     Description :
