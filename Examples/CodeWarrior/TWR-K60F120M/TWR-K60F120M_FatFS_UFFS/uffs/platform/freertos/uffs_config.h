 ...
 */
#define UFFS_MAX_PAGE_SIZE		NFC_DATA_SIZE

/**
 * \def UFFS_MAX_SPARE_SIZE
 */
#define UFFS_MAX_SPARE_SIZE 	NFC_SPARE_SIZE

/**
 * \def UFFS_MAX_ECC_SIZE
 */
#define UFFS_MAX_ECC_SIZE  		NFC_ECC_SIZE		//((UFFS_MAX_PAGE_SIZE / 256) * 5)
 ...
 *       Must be > CLONE_BUFFERS_THRESHOLD+3
 */
...
#define CONFIG_MAX_PENDING_BLOCKS	2
 ...
 */
#define MAX_OBJECT_HANDLE	50 //16	//50
