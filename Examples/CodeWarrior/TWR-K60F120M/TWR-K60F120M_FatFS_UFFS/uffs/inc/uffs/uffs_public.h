...
#include "uffs_config.h"	//MSL 1/27/14 support completely stripping debug when disabled (save string space etc.)
...
#ifdef CONFIG_ENABLE_UFFS_DEBUG_MSG  // MSL strip debug info when not used
...
#define uffs_Perror(level, fmt, ... ) {}
#define uffs_PerrorRaw(level, fmt, ... ) {}
#define uffs_Assert(expr, msg, ...) U_TRUE
