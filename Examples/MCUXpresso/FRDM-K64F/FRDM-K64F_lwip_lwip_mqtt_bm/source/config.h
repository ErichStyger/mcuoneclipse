...
/* connection settings to broker */
  ...
  #define CONFIG_CLIENT_USER_NAME       "erichs" /* Adafruit IO Username, keep it SECRET! */
  #define CONFIG_CLIENT_USER_PASSWORD   "7f60644fb5614b9eb0839705a03d2c18" /* Adafruit AIO Key, keep it SECRET! */
