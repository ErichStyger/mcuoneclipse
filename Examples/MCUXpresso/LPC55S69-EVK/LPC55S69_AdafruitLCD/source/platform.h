...
#define PL_CONFIG_USE_GUI_TOUCH_NAV     (0 && (PL_CONFIG_USE_FT6206 || PL_CONFIG_USE_STMPE610) && PL_CONFIG_USE_GUI) /* if using touch on display */
#define PL_CONFIG_USE_GUI_KEYPAD_NAV    (0 && PL_CONFIG_USE_GUI) /* keyboard on LCD */
#define PL_CONFIG_USE_GUI_SCREEN_SAVER  (0 && PL_CONFIG_USE_GUI) /* By default, it turns off the display */
#define PL_CONFIG_USE_TOASTER           (0 && PL_CONFIG_USE_GUI_SCREEN_SAVER) /* Not yet implemented! */
#define PL_CONFIG_USE_GUI_SYSMON        (0 && PL_CONFIG_USE_GUI)
