...
#define BOARD_LEDBLUE_GPIO GPIOC               /*!<@brief GPIO peripheral base pointer */
#define BOARD_LEDBLUE_GPIO_PIN_MASK (1U << 2U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_LEDBLUE_PORT PORTC               /*!<@brief PORT peripheral base pointer */
#define BOARD_LEDBLUE_PIN 2U                   /*!<@brief PORT pin number */
