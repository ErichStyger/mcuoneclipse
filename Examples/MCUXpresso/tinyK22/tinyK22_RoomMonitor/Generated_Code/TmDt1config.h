...
#define TmDt1_INIT_IN_STARTUP                               0 /* 1: call Init() during startup, 0: application needs to call Init() */
...
#define TmDt1_INIT_SOFTWARE_RTC_METHOD                      TmDt1_INIT_SOFTWARE_RTC_FROM_EXTERNAL_RTC /* which method to use during Init() */
...
#define TmDt1_USE_EXTERNAL_HW_RTC                           1  /* set to 1 if using external HW RTC driver, 0 otherwise */
