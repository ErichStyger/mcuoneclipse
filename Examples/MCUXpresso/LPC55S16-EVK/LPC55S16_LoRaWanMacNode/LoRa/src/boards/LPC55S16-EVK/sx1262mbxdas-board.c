#if PL_CONFIG_RADIO_TRANSEIVER_TYPE==1262
/*!
...
void SX126xIoInit( void )
{
    ...
    GpioInit( &DeviceSel, RADIO_DEVICE_SEL_PIN, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
}
...
#endif /* PL_CONFIG_RADIO_TRANSEIVER_TYPE==1262 */
