...
pin_labels:
- {pin_num: '8', pin_signal: SWCLK/PIO0_3, label: 'CN3[4]/CN1[36]/SWCLK/PIO0_3/TCK', identifier: K3}
- {pin_num: '10', pin_signal: SWDIO/PIO0_2, label: 'CN3[2]/CN1[37]/SWDIO/PIO0_2/TMS', identifier: K4}
...
void BOARD_InitSWD_DEBUGPins(void)
{
    ...
    const uint32_t K4 = (/* Selects pull-up function */
                         IOCON_PIO_MODE_PULLUP |
                         /* Enable hysteresis */
                         IOCON_PIO_HYS_EN |
                         /* Input not invert */
    ...
    IOCON_PinMuxSet(IOCON, IOCON_INDEX_PIO0_2, K4);
    ...
    IOCON_PinMuxSet(IOCON, IOCON_INDEX_PIO0_3, K3);
...
- options: {callFromInitBoot: 'false', coreID: core0, enableClock: 'true'}
- pin_list:
  - {peripheral: SWD, signal: SWCLK, pin_signal: Disabled}
  - {peripheral: SWD, signal: SWDIO, pin_signal: Disabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_DisableDebug
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
/* Function assigned for the Cortex-M0P */
void BOARD_DisableDebug(void)
{
    /* Enables clock for switch matrix.: enable */
    CLOCK_EnableClock(kCLOCK_Swm);
