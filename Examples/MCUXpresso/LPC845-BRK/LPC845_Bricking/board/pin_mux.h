...
/*! @name SWDIO (number 10), CN3[2]/CN1[37]/SWDIO/PIO0_2/TMS
  @{ */
#define BOARD_INITSWD_DEBUGPINS_K4_PORT 0U                  /*!<@brief PORT device index: 0 */
#define BOARD_INITSWD_DEBUGPINS_K4_PIN 2U                   /*!<@brief PORT pin number */
#define BOARD_INITSWD_DEBUGPINS_K4_PIN_MASK (1U << 2U)      /*!<@brief PORT pin mask */
                                                            /* @} */

/*! @name SWCLK (number 8), CN3[4]/CN1[36]/SWCLK/PIO0_3/TCK
  @{ */
#define BOARD_INITSWD_DEBUGPINS_K3_PORT 0U                  /*!<@brief PORT device index: 0 */
#define BOARD_INITSWD_DEBUGPINS_K3_PIN 3U                   /*!<@brief PORT pin number */
#define BOARD_INITSWD_DEBUGPINS_K3_PIN_MASK (1U << 3U)      /*!<@brief PORT pin mask */
                                                            /* @} */
 ...
 *
 */
void BOARD_DisableDebug(void); /* Function assigned for the Cortex-M0P */
