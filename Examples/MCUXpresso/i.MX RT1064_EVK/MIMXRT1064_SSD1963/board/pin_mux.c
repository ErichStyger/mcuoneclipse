...
- {pin_num: F14, pin_signal: GPIO_AD_B0_09, label: 'JTAG_TDI/J21[5]/ENET_RST/J22[5]', identifier: LED_GREEN}
...
- pin_list:
  - {pin_num: F14, peripheral: GPIO1, signal: 'gpio_io, 09', pin_signal: GPIO_AD_B0_09, direction: OUTPUT, gpio_init_state: 'true', hysteresis_enable: Disable, pull_up_down_config: Pull_Down_100K_Ohm,
...
void BOARD_InitPins(void) {
  ...
  /* GPIO configuration of LED_GREEN on GPIO_AD_B0_09 (pin F14) */
  ...
  GPIO_PinInit(GPIO1, 9U, &LED_GREEN_config);
