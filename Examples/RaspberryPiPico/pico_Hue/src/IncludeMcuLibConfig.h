...
//#include "McuFlash.h"
#define CONFIG_FLASH_TARGET_OFFSET     (256*4*1024)
#define CONFIG_FLASH_ADDRESS_START     (XIP_BASE + CONFIG_FLASH_TARGET_OFFSET)
#define CONFIG_FLASH_NUMBER_OF_PAGES   (16) /* memory size aligned to 4K! */
...
#define MCULITTLEFS_CONFIG_BLOCK_COUNT                (128) /* 4k each */
/* -------------------------------------------------*/
/* McuLog */
