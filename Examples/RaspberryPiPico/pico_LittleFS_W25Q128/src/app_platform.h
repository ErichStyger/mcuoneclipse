...
#define PL_CONFIG_USE_EXT_FLASH       (1 && !PL_CONFIG_USE_BUTTONS) /* if using externals SPI flash (uses nav switch button pins!) */
#define PL_CONFIG_USE_LITTLE_FS       (1 && PL_CONFIG_USE_EXT_FLASH)
