...
#define ENABLE_BACKDOOR  (PL_CONFIG_USE_ARES_BACKDOOR /*|| PL_CONFIG_USE_ARES_HACKATHON*/)
#define DISABLE_MASS_ERASE (0) /* DO NOT ENABLE THIS IF YOU DON'T KNOW WHAT YOU ARE DOING!!!!!!! */
...
__attribute__ ((used,section(".FlashConfig"))) const struct Flash_Config {
  ...
  #if ENABLE_BACKDOOR
    0xdeadbeef, /* backdoor key */
    0xfeedbabe, /* backdoor key */
    ...
    #if ENABLE_BACKDOOR /* flash security enabled */
