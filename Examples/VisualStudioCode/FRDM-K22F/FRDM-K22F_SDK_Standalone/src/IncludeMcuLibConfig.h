...
#define PL_CONFIG_IS_FRDM_K22F                      (1) /* FRDM board, otherwise tinyK22 */
...
/* ---------------------------------------------------------------------- */
/* McuShell */
#define McuShell_CONFIG_PROJECT_NAME_STRING         "ARES"
#define McuShell_CONFIG_PROMPT_STRING               "root> "
/* ------------------- McuShellUart -----------------------*/
...
#if 1 //PL_CONFIG_USE_ARES_HACKATHON
  #define McuLog_CONFIG_LOG_FILENAME          (0) /* if file names are used for the log */
  #define McuLog_CONFIG_LOG_LINE_NUMBER       (0) /* if line numbers are used for the log */
  #define McuLog_CONFIG_USE_FILE_MACRO        "unknown" /* obfusificate file name */
#else
...
/* ---------------------------------------------------------------------------------------*/
#define McuFlash_CONFIG_IS_ENABLED          (1)       /* 1: McuFlash is enabled; 0: McuFlash is disabled*/
