...
#define McuLib_CONFIG_CPU_IS_STM32                  (1)
#define McuLib_CONFIG_CORTEX_M                      (4) /* Cortex M4F */
...
#define SYSVIEW_APP_NAME                            "STM32 F303K8"
#define SYSVIEW_DEVICE_NAME                         "STM32F303K8"
/* -------------------------------------------------*/
/* Shell */
