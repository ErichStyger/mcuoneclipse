...
#define	_USE_STRFUNC	%UseStringFunctions	/* 0:Disable or 1/2:Enable */
...
#define	_USE_LFN	%UseLFN		/* 0 to 3 */
#define	_MAX_LFN	%MaxLFN		/* Maximum LFN length to handle (12 to 255) */
...
#define _FS_RPATH	%RelativePath		/* 0 to 2 */
...
#define _MAX_SS                %MaxSectorSize  /* 512, 1024, 2048 or 4096 */
...
#define	_FS_SHARE	%FsShare	/* 0:Disable or >=1:Enable */
