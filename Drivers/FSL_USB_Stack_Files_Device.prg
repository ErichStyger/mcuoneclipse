%-
%- Freescale USB Stack source files for CDC or HID Keyboard Devices
%-
...
%elif (CPUDevice="Kinetis K20D50") |(CPUDevice="Kinetis K40") | (CPUDevice="Kinetis K53") | (CPUDevice="Kinetis K60") | (CPUDevice="Kinetis L2K")
