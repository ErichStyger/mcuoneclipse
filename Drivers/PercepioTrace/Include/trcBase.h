...
#include <stdio.h>
#include <string.h>
#ifdef __HIWARE__ /* << EST */ /* Freescale S08 and S12 are only C89 compliant */
  #include "PE_Types.h"
#else
  #include <stdint.h>
#endif
...
#if 1 /* << EST */
extern uint16_t eventCount[EVENT_COUNT_SIZE];
extern char sprintfBuffer[EVENT_SPRINT_F_BUF_SIZE];
#endif
