...
set(OBJECT_GEN_FLAGS "-O0 -fno-common -g3 -ggdb -Wall -ffunction-sections -fdata-sections -ffreestanding -fno-builtin -fmerge-constants -fno-common -mcpu=cortex-m33 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb")
...
set(CMAKE_EXE_LINKER_FLAGS_DEBUG "-ggdb -lm -lc -lgcc -lnosys -lc" CACHE INTERNAL "Linker options for debug build type")
...
set(CMAKE_EXE_LINKER_FLAGS_RELEASE "-flto -lm -lc -lgcc -lnosys" CACHE INTERNAL "Linker options for release build type")
